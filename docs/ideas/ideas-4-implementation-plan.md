...
5. Goals UI (list, form, cards)
6. Goal entry methods (manual, bulk)

### Sprint 3: AI Integration
7. AI-assisted goal entry
8. Goal decomposition with LLM
9. Goal augmentation for existing goals

### Sprint 4: Search & Polish
10. Global search service and UI
11. UX improvements (autofocus, shortcuts)
12. Auto-scheduler goal integration

### Sprint 5: Dashboard & Analytics
13. Goal progress dashboard
14. Goal tracking in calendar view
